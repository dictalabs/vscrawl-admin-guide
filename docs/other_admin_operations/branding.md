...
vScrawl is a brandable application. In addition to the option to change the language in the **Application Settings**, it is also possible to change the visual appearance.  
